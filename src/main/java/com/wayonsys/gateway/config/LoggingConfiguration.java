...
public class LoggingConfiguration {
    ...
    public LoggingConfiguration(@Value("${spring.application.name}") String appName, @Value("${server.port}") String serverPort,
         Optional<ConsulRegistration> consulRegistration, Optional<BuildProperties> buildProperties, JHipsterProperties jHipsterProperties) {
        this.appName = appName;
        this.serverPort = serverPort;
        this.consulRegistration = consulRegistration.orElse(null);
    ...
    private String customFields () {
        ...
        if (this.consulRegistration != null) {
            customFields.append(",").append("\"instance_id\":\"").append(this.consulRegistration.getInstanceId()).append("\"");
        }
